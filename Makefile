...
OBJS= MATRIX_SPARSE.o ED_BATH_TYPE.o ED_VARS_GLOBAL.o ED_INPUT_VARS.o ARPACK_LANCZOS.o PLAIN_LANCZOS.o ED_AUX_FUNX.o ED_EIGENSPACE.o ED_BATH.o ED_MATVEC.o ED_HAMILTONIAN.o ED_GREENS_FUNCTIONS.o ED_OBSERVABLES.o ED_ENERGY.o ED_CHI2FIT.o ED_DIAG.o ED_MAIN.o ED_WRAP_DIAG.o ED_WRAP_ENERGY.o ED_WRAP_GLOC.o ED_WRAP_WEISS.o DMFT_ED.o
