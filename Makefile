...
OBJS= ED_SPARSE_MATRIX.o ED_INPUT_VARS.o ED_VARS_GLOBAL.o  ED_AUX_FUNX.o ED_IO.o ED_SETUP.o ED_EIGENSPACE.o ED_BATH.o ED_BATH_FUNCTIONS.o ED_MATVEC.o ED_HAMILTONIAN.o ED_DIAG.o ED_OBSERVABLES.o ED_GREENS_FUNCTIONS.o  ED_CHI2FIT.o ED_MPI2B.o ED_GLOC.o ED_WEISS.o  ED_MAIN.o DMFT_ED.o


#TRY TO USE THE DMFT_TOOLS ONES
#
#ED_ENERGY.o ==> DMFTT_EKIN
