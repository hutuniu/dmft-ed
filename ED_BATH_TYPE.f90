MODULE ED_BATH_TYPE
  ...
  type effective_bath
     ...
     !complex(8),dimension(:,:,:),allocatable       :: vc    !diagonal hyb.  [Nspin][Norb][Nbath]              COMPLEX
     complex(8),dimension(:,:,:,:,:),allocatable   :: h     !Replica hamilt [Nspin][Nspin][Norb][Norb][Nbath] COMPLEX
