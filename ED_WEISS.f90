module ED_WEISS
  ...
  interface ed_get_weiss
     module procedure ed_get_weiss_field_normal_hloc
     module procedure ed_get_weiss_field_normal_hloc_1b
     module procedure ed_get_weiss_field_normal_hloc_mb
     module procedure ed_get_weiss_field_superc_hloc
     module procedure ed_get_weiss_field_superc_hloc_1b
     module procedure ed_get_weiss_field_superc_hloc_mb
...
contains
  ...
  subroutine ed_get_weiss_field_normal_hloc(Gloc,Smats,Weiss,Hloc,iprint)
    ...
    if(Nspin*Norb==1)then
       do i=1,Lmats
          invGloc_site(1,1,i) = one/invGloc_site(1,1,i)
       enddo
    else
       do i=1,Lmats
    ...
    if(cg_scheme=="weiss")then
       ...
       if(Nspin*Norb==1)then
          do i=1,Lmats
             calG0_site(1,1,i) = one/calG0_site(1,1,i)
          enddo
       else
          do i=1,Lmats
